...
/**
 * Suitability Analysis: MapLibre canvas + draw zone → Analyze Area.
 * Same smart-analysis flow as admin Analytics, under /app for regular users.
 */
...
<template>
  <div class="relative h-full w-full overflow-hidden">
    <div class="relative h-full w-full">
      ...
      >
        <TypographySmall as="p" class="text-xs font-medium">Suitability Analysis</TypographySmall>
